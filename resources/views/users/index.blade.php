...
<div class="card">
    <div class="card-body">
        <button class="btn btn-outline-success float-right mr-5 mb-2" data-toggle="modal" data-target="#myModal">
            <span class="fa fa-plus" aria-hidden="true"></span> USER
        </button>
        <table class="table table-borderless">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src="{{ 'storage/' . $user->img }}" width="40px" style="border-radius: 40%"></td>
                    <td>{{ $user->name }}</td>
                    <td>{{ $user->email }}</td>
                    <td>
